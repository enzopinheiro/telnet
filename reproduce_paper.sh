...
# 1) This shell script reproduces the results of the paper "An interpretable machine learning model for seasonal precipitation forecasting" 
...
# 5) Once the dataset is downloaded, an environmental variable "TELNET_DATADIR" should be set to the path of the dataset
